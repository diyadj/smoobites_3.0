...
func sendResetEmail(to, resetLink string) error {
	...
	m.SetBody("text/plain", fmt.Sprintf("To reset your password, click the following link: %s. This link expires in an hour. If you did not request to reset your password, please ignore this email.", resetLink))
