...
(function ($) {
  ...
  var loadMyCartEvent = function(userOptions){
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td title="Total" class="' + classProductTotal + '">$' + total.toFixed(2) + '</td>' +
    ...
    var showGrandTotal = function(products){
      ...
      total = Math.round(total * 100) / 100;
      $("#" + idGrandTotal).text("$" + total.toFixed(2));
    }
    var showDiscountPrice = function(products){
      var discountPrice = options.getDiscountPrice(products);
      if (discountPrice !== null) {
        discountPrice = Math.round(discountPrice * 100) / 100; // Round to two decimal places
        $("#" + idDiscountPrice).text("$" + discountPrice.toFixed(2));
      }
    }
